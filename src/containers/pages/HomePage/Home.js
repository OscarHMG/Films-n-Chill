      ...
      <div>
        <div className="row">
          <div className={style.containerImg}>
            ...
            <div className={style.Centered}>
              ...
              <h5 className="white-text">Series y documentales a un click.</h5>
        ...
        <div className={"row valign-wrapper " + style.ContainerDescription}>
          <div className={"col s6 " + style.TextDescriptionContainer}>
            <h3 className={"white-text " + style.TitleDescription}>
              Todo a un click.
            </h3>
            <p className={"white-text " + style.TextDescription}>
              Todo lo que quieras ver, sin límites ni comerciales. Siempre hay
